<?php
   session_start();
   define("APPURL", "");
   define("HEADERURL","http://localhost:8000/anime-main");
   define("LOGINURL","http://localhost:8000/auth/login.php");
   define("IMGURL","http://localhost:8000/admin-panel/shows-admins/img");
   define("VIDEOSURL","http://localhost:8000/admin-panel/episodes-admins/videos");
                ...
                <div class="col-lg-8">
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                <li><a href="<?php echo HEADERURL; ?>">Homepage</a></li>
                            ...
                            <?php endif; ?>
                            <?php if(!isset($_SESSION['username'])) : ?>
                               <a href="<?php APPURL; ?>/auth/login.php"><span class="icon_profile"></span></a> 
