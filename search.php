...
<?php
   ...
   if (isset($_POST['submit'])) {
       if (empty($_POST['keyword'])) {
          echo "<script>location.href='".HEADERURL."'</script>";
       } else{
           $keyword = $_POST['keyword'];

           $scarch = $conn->query("SELECT * FROM shows WHERE title OR genre LIKE '%$keyword%'");
           $scarch->execute();

           $allSearches = $scarch->fetchAll(PDO::FETCH_OBJ);
       }
    }
            ...
            <div class="col-lg-8">
                <div class="product__page__content">
                    ...
                    <div class="row">
                        ...
                        <?php endforeach; ?>
                    <?php else : ?>
                        <p class="text-white">no shows for your scarch yet</p>
                    <?php endif; ?>
                    </div>
                </div>
